\usepackage[utf8]{inputenc}  % Allows the use of UTF-8 encoding (for Cyrillic characters)
\usepackage[russian,english]{babel}  % Allows switching between English and Russian
