...
\begin{Proof} [Division Algorithm]
    ...
    can't exceed the size of the original cake: between nothing left or sharing nothing, i.e., \underline{``$0\leq r<b$''}.\\
    ...
    \noindent
    For \underline{``$r<b$''} we argue by contradiction ``$r\geq b$'' then ``$r=a-bq\geq b$''. Subtract $b$ from both sides,
    ``$(r-b=a-bq-b)\geq (b-b$ = 0)'' factoring we see ``$r-b=a-b(q+1)$''. Since
        ...
        \noindent
        For $q,r$ uniqueness, we argue by contradiction, assume another pair $q',r'$ such that\\
