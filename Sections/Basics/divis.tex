...
\begin{Proof} [Division Algorithm]
    ...
    \noindent
    \textbf{Intuitively:} I cut a cake of size $a$ for $q$ people. I cut $b$ big slices. I can't have
    more leftovers than the size of the cake: I either have none left or shared nothing, i.e., \underline{``$0\leq r<b$''}\\
